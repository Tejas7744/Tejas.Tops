    ...
    return (
      <div className="body">
        ...
        <div className="head">
          <div className="text">
            <p className="p1">
                Scalable Landing Pages With Trending Designs
            </p>
            <br />
          </div>
          <div className="text-2">
            <p className="p2">
              Welcome to Superprops - the leading landing page templates, built
              with React, Gatsby JS & Styled Components. No jQuery!!!
            </p>
          </div>
        </div>
